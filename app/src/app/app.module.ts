...
import { CatTipoClienteComponent } from './ui/view-models/cat-tipo-cliente/cat-tipo-cliente.component';
...
import { TblClienteComponent } from './ui/view-models/tbl-cliente/tbl-cliente.component';
import { TblFacturaComponent } from './ui/view-models/tbl-factura/tbl-factura.component';
import { TblDetalleFacturaComponent } from './ui/view-models/tbl-detalle-factura/tbl-detalle-factura.component';
...
@NgModule({
  declarations: [
    ...
    CatTipoClienteComponent,
    TblClienteComponent,
    TblFacturaComponent,
    TblDetalleFacturaComponent,
    FacturasComponent,
    BusquedaComponent,
  ...
  providers: [
    ...
    // TblDetalleFactura
    {
      provide: TblDetalleFacturaGateway,
      useClass: TblDetalleFacturaApiService,
    },
    // TblFactura
