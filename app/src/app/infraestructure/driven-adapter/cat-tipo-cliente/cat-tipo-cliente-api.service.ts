...
import { CatTipoCliente } from 'src/app/domain/models/cat-tipo-cliente/cat-tipo-cliente';
import { CatTipoClienteGateway } from 'src/app/domain/models/cat-tipo-cliente/gateway/cat-tipo-cliente-gateway';
