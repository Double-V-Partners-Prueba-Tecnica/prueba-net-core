...
namespace Api.Repository.Implement.CatProductoRepository
{
    public class CatProductoRepositoryImpl : ICatProductoRepository
    {
        ...
        public async Task<CatProducto?> CreateAsync(CatProducto entity)
        {
        ...
        public async Task<CatProducto?> DeleteAsync(int id)
        {
            using (var conn = new SqlConnection(_strConn))
            {
        ...
        public async Task<CatProducto?> UpdateAsync(CatProducto entity)
        {
            using (var conn = new SqlConnection(_strConn))
            {
        ...
        private SqlParameter[] MapToParameters(CatProducto entity)
        {
            return new SqlParameter[]
            {
                ...
                new ("@UpdatedAt", entity.UpdatedAt),
                new ("@DeletedAt", entity.DeletedAt)
            };
        }
    }
}
